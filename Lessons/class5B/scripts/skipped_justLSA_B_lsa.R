...
# Bring in some data
carCorp <- VCorpus(DirSource("~/Desktop/hult_NLP_student/lessons/class5/data/AutoAndElectronics/rec.autos"))
electronicCorp <- VCorpus(DirSource("~/Desktop/hult_NLP_student/lessons/class5/data/AutoAndElectronics/rec.autos"))
